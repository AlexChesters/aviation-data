...
describe('getAirfields', () => {
  it('returns an array of the expected type', async () => {
    ...
    expect(typeof data[0].latitude).toEqual('string')
    expect(typeof data[0].longitude).toEqual('string')
    expect(typeof data[0].elevation).toEqual('string')
    ...
    expect(typeof data[0].scheduledService).toEqual('string')
